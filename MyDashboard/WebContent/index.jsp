                    ...
                    <div class="row top_tiles" id="row-1">
                            ...
                            <div error-condition="heartbeat.error" class="tile-stats pulser" id="front-4">
                                ...
                                <p>Monitors system availability</p>
									...
									<div class="container">
									    ...
									    <li class="active"><a data-toggle="tab" href="#cpu_tab" ng-click="setTabIndex(tabIndex.CPU)"><i class="fa fa-laptop"></i> Tweets</a></li>
									    <li><a data-toggle="tab" href="#memory_tab" ng-click="setTabIndex(tabIndex.MEMORY)"><i class="fa fa-ticket"></i> Tab 2</a></li>
									    <li><a data-toggle="tab" href="#disk_tab" ng-click="setTabIndex(tabIndex.DISK)"><i class="fa fa-database"></i> Tab 3</a></li>
									    <li><a data-toggle="tab" href="#network_tab" ng-click="setTabIndex(tabIndex.IO)"><i class="fa fa-sitemap"></i> Tab 4</a></li>
									    <li><a data-toggle="tab" href="#os_tab" ng-click="setTabIndex(tabIndex.OS)"><i class="fa fa-windows"></i> Tab 5</a></li>									    
									  </ul>
	                  ...
	                  <!-- CPU Details Tab -->				
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Tweet Statistics<small>Avg Response Times</small></h2>
